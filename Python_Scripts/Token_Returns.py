...
class TokenReturn:
    ...
    def __init__(self):
        self.launchpad_db_path = '/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Launchpad_db/Binance_Launchpad_R1.csv'
        self.token_hour_db_path = '/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Token_hour_db/'
        self.token_daily_db_path = '/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Token_daily_db/'
        self.token_transform_hour_db_path = '/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Token_Transform_db/Hour_BNBUSDT.csv'
        self.tokens_trasnform_daily_br_path = '/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Token_Transform_db/Daily_BNBUSDT.csv'
    ...
    def generating_launchpad_db():
        ...
        Save into csv.
        """
        df = pd.read_csv('/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Launchpad_db/Binance_Launchpad.csv',
                         index_col=1)
    ...
    def token_returns(self):
        ...
        :return: generate a dictionary with the returns: 1h, 3h, 5h, 1d, 5d
        """
        final_db = dict()
        contador = 0
        for key, value in self.token_index.items():
            if value == 'BNB':
                ...
                # Returns
                ret_1h = ((hour_path.iloc[1, 1]/launchpad_df.iloc[contador, 2])-1)*100
                ret_3h = ((hour_path.iloc[3, 1]/launchpad_df.iloc[contador, 2])-1)*100
                ret_5h = ((hour_path.iloc[5, 1]/launchpad_df.iloc[contador, 2])-1)*100
                ret_1d = ((daily_path.iloc[1, 1]/launchpad_df.iloc[contador, 2])-1)*100
                ret_5d = ((daily_path.iloc[5, 1]/launchpad_df.iloc[contador, 2])-1)*100
    ...
    def final_data_treatment(token_return):
        ...
        # Save into excel
        return df.to_excel('/Users/rodrigow/PycharmProjects/launchpad_binance_r1/Return_Results/Final_Results.xlsx')
